(define (problem ejercicio7)
    ...
    (:init
        ...
        ; establecemos los tiempos necesarios para la construccion de cada tipo de edificio
        (= (cantidad_tiempo_requiere Barracones) 46)
        (= (cantidad_tiempo_requiere Extractores) 21)

        ; establecemos los tiempos necesarios para el reclutamiento de cada tipo de unidad
        (= (cantidad_tiempo_requiere VCE) 12)
        (= (cantidad_tiempo_requiere Marines) 18)
        (= (cantidad_tiempo_requiere Segadores) 32)

        ; establecemos la velocidad de deplazamiento de cada tipo de unidad
        (= (velocidad_unidad_tipo VCE) 1)
        (= (velocidad_unidad_tipo Marines) 5)
        (= (velocidad_unidad_tipo Segadores) 10)

        ; el tiempo total al iniciar el ejercicio es 0
        (= (tiempoTrascurrido) 0)
